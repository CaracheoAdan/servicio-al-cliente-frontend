...
export function Sidebar() {
  ...
  return (
    <aside className={`${collapsed ? 'w-24' : 'w-72'} flex-shrink-0 py-5 pl-5 pr-3 transition-all duration-300 ease-in-out`}>
      <div className="sidebar-card bg-white border border-[#E2E8F0] border-r-[4px] border-r-[#2A5D8F] shadow-[12px_0_28px_-6px_rgba(42,93,143,0.12)] dark:border-[#27272A] dark:border-r-[#2A5D8F] dark:shadow-[12px_0_28px_-6px_rgba(0,0,0,0.5)] rounded-2xl flex flex-col h-full overflow-hidden">
